...
import heroScreenshotImageSrc from "images/logo1.png";
...
export default ({
  ...
  description = "Stories from the world’s leading digital asset platform where you have full control of your crypto."
}) => {
        ...
        <Content2Xl>
          <NavRow>
            ...
            <div tw="flex flex-wrap justify-center lg:justify-end items-center -mr-12">
              <NavLink target="_blank" href="https://www.blockchain.com/wallet">
                Wallet
              </NavLink>
              <NavLink target="_blank" href="https://exchange.blockchain.com/">
               Exchange
              </NavLink>
              <NavLink target="_blank" href="https://www.blockchain.com/explorer">
               Explorer
              </NavLink>
              <NavLink target="_blank" href="https://www.investopedia.com/financial-advisor-4427709">
              Advisors
              </NavLink>
              <div tw="md:hidden flex-100 h-0"></div>
              <PrimaryNavLink target="_blank" href="https://login.blockchain.com/#/signup?utm_campaign=exppromo_getstarted">
                Login
              </PrimaryNavLink>
              <PrimaryNavLink target="_blank" href="https://login.blockchain.com/#/signup?utm_campaign=exppromo_getstarted">
                SignUp
